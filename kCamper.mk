GEN_OBJ         = kCamper.o ui.o sensor.o valve.o pump.o lib/uart.o  lib/ds18b20_simple_fix.o lib/gpio.o lib/flow.o lib/timer.o #lib/env_test.o
...
.uart_upload:$(PRG).hex
	sudo avrdude  -p m328p -c stk500v1 -P /dev/ttyUSB0 -b 57600 -U flash:w:$(PRG).hex:i
